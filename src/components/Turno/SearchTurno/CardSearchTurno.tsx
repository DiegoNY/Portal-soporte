    ...
    return (
        <section className=" w-[400px] lg:w-[23rem] mx-2 col-span-2 p-2 ">
            <div className="w-full flex gap-2">
                ...
                <button
                    className="text-[14px] px-2 text-center border shadow-sm bg-white hover:bg-sky-100 hover:text-blue-700 hover:font-[500] rounded-lg p-1 items-center flex  "
            ...
            <div className="mt-2 bg-slate-200 h-[80vh] md:h-[100vh] lg:h-[80vh] shadow-sm overflow-y-scroll custom-scroll">
                {children}
            </div>
        </section>
    )
