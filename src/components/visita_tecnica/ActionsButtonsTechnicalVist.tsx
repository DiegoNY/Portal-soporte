...
import { ButtonAction } from "../incidencias/registro/presentation_incidents/ButtonAction";
import { ChangeViewDetail } from "@/libs/redux/feature/Incidents.feature";

export const ActionsButtonsTechnicalVist = () => {
  ...
  return (
    ...
    >
      <ButtonAction
        onClick={() => {
          route.push(
            "/home/incidencias/visita_tecnica/orden_visita?numero=" + "23-23255"
          );
        }}
        icon={
          <svg
