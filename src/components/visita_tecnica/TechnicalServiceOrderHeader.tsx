...
export const TechnicalServiceOrderHeader = () => {
  return (
    <section className="mt-1  grid grid-cols-2  sm:flex justify-between gap-5 items-center p-5 mb-0.5">
      ...
      <div className="sm:w-[42vw] text-center text-[14px] col-span-2">
        <h1 className="font-[700] text-[15px] text-teal-700">
          ORDEN DE VISITA TECNICA (OVT)
        </h1>
